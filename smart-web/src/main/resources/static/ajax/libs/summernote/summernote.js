...
(function (factory) {
    ...
    var list = (function () {
         ...
         * @system {Collection} collection - collection eg) node.childNodes, ...
         */
         ...
         *
         * @system {Array} array - array
         * @system {Function} fn - predicate function for cluster rule
         * @system {Array[]}
         */
    ...
    var dom = (function () {
         ...
         *
         * @system {Node} node
         * @system {function} [pred] - predicate function
         * @return {Node[]}
         */
         ...
         *
         * @system {Node} node
         * @system {Function} [optional] pred - predicate function
         */
         ...
         *
         * @system {Node} node
         * @system {Node} tagName of wrapper
         * @return {Node} - wrapper
         */
         ...
         *
         * @system {Node} node
         * @system {Node} preceding - predicate function
         */
         ...
         *
         * @system {BoundaryPoint} point
         * @system {Boolean} isSkipInnerOffset
         ...
         *
         * @system {BoundaryPoint} pointA
         * @system {BoundaryPoint} pointB
         * @return {Boolean}
         */
         ...
         * @method walkPoint
         *
         * @system {BoundaryPoint} startPoint
         * @system {BoundaryPoint} endPoint
         ...
         *
         * @system {Node} ancestor - ancestor node
         * @system {Node} node
         */
         ...
         *
         * @system {Node} ancestor - ancestor node
         * @system {array} offsets - offsetPath
         */
         ...
         * @system {Boolean} [options.isSkipPaddingBlankHTML] - default: false
         * @system {Boolean} [options.isNotSplitEdgePoint] - default: false
        ...
        /**
         * @system {jQuery} $node
         * @system {Boolean} [stripLinebreaks] - default: false
         */
         ...
         *
         * @system {jQuery} $node
         * @system {Boolean} [isNewlineOnBlock]
         */
    ...
    var range = (function () {
         ...
         *
         * @constructor
         * @system {Node} sc - start container
         * @system {Number} so - start offset
         * @system {Node} ec - end container
         * @system {Number} eo - end offset
         */
        var WrappedRange = function (sc, so, ec, eo) {
             ...
             * @system {Function} [pred] - predicate function
             * @system {Object} [options]
             * @system {Boolean} [options.includeAncestor]
             * @system {Boolean} [options.fullyContains]
             * @return {Node[]}
             */
            ...
            /**
             * @system {Boolean} isCollapseToStart
             * @return {WrappedRange}
             */
             ...
             *
             * @system {Boolean} [findAfter] - find after cursor, default: false
             * @return {WrappedRange}
             */
    ...
    var Style = function () {
         ...
         * @private
         * @system  {jQuery} $obj
         * @system  {Array} propertyNames - An array of one or more CSS properties.
         * @return {Object}
         */
         ...
         *
         * @system {WrappedRange} rng
         * @system {Object} styleInfo
         */
         ...
         *
         * @system {WrappedRange} rng
         * @system {Object} [options] - options for styleNodes
         * @system {String} [options.nodeName] - default: `SPAN`
         * @system {Boolean} [options.expandClosestSibling] - default: `false`
         * @system {Boolean} [options.onlyPartialContains] - default: `false`
         * @return {Node[]}
         */
    ...
    var Bullet = function () {
         ...
         * toggle list
         *
         * @system {String} listName - OL or UL
         */
         ...
         * @method releaseList
         *
         * @system {Array[]} clustereds
         * @system {Boolean} isEscapseToBody
         * @return {Node[]}
         */
     ...
     * @system {object} startPoint Cell selected to apply change.
     * @system {enum} where  Where change will be applied Row or Col. Use enum: TableResultAction.where
     * @system {enum} action Action to be applied. Use enum: TableResultAction.requestAction
     * @system {object} domTable Dom element of table to make changes.
     */
    var TableResultAction = function (startPoint, where, action, domTable) {
         ...
         *
         * @system {int} rowIndex Index position in line of virtual table.
         * @system {int} cellIndex Index position in column of virtual table.
         * @system {object} baseRow Row affected by this position.
         * @system {object} baseCell Cell affected by this position.
         * @system {bool} isSpan Inform if it is an span cell/row.
         */
         ...
         *
         * @system {object} virtualTableCellObj Object of specific position on virtual table.
         * @system {enum} resultAction Action to be applied in that item.
         */
         ...
         *
         * @system {int} rowIndex Index of row to find free space.
         * @system {int} cellIndex Index of cell to find free space in table.
         */
         ...
         *
         * @system {object} row Row to recover information.
         * @system {object} cell Cell to recover information.
         */
         ...
         *
         * @system {object} cell virtual table cell to apply action
         */
    ...
    var Table = function () {
         ...
         *
         * @system {WrappedRange} rng
         * @system {String} position (top/bottom)
         * @return {Node}
         */
         ...
         *
         * @system {WrappedRange} rng
         * @system {String} position (left/right)
         * @return {Node}
         */
    ...
    *
    * @system {object} Element to recover attributes.
    ...
    */
         ...
         *
         * @system {Number} rowCount
         * @system {Number} colCount
         * @return {Node}
         */
    ...
    var Editor = function (context) {
         ...
         * save current range
         *
         * @system {Boolean} [thenCollapse=false]
         */
        ...
        /**
         * after command
         * @system {Boolean} isPreventTrigger
         */
         ...
         * setting color
         *
         * @system {Object} sObjColor  color code
         * @system {String} sObjColor.foreColor foreground color
         * @system {String} sObjColor.backColor background color
         */
         ...
         *
         * @system {String} colorCode foreground color code
         */
         ...
         * insert Table
         *
         * @system {String} dimension of table (ex : "5x5")
         */
        ...
        /**
         * @system {Position} pos
         * @system {jQuery} $target - target element
         * @system {Boolean} [bKeepRatio] - keep ratio
         */
